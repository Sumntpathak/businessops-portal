...
export function buildInstructions(session: CallSession): string {
  ...
  return [
    ...
    memories,
    "",
    "== ULTRA-LOW LATENCY & IMMEDIATE AUDIO DIRECTIVE ==",
    "- Speak aloud IMMEDIATELY on every turn in under 300 milliseconds. Never hesitate, pause, or deliberate.",
    "- NEVER generate silent reasoning, chain-of-thought, or internal analysis. Stream spoken audio output directly.",
    "- Open EVERY turn with an instant, natural 1-word or short micro-acknowledgment ('Sure —', 'Got it —', 'Haan ji —', 'Achha —', 'Right —') while resolving the answer.",
