...
async function seed() {
  ...
  console.log("  admin@businessops.dev    / Admin@1234");
  console.log("  manager@businessops.dev  / Manager@1234");
  console.log("  agent1@businessops.dev   / Agent@1234");
  console.log("  agent2@businessops.dev   / Agent@1234");
  console.log("  finance@businessops.dev  / Finance@1234");
}
